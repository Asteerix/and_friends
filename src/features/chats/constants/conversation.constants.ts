...
export type MessageType =
  (typeof CONVERSATION_CONSTANTS.MESSAGE_TYPES)[keyof typeof CONVERSATION_CONSTANTS.MESSAGE_TYPES];
export type ChatStatus =
  (typeof CONVERSATION_CONSTANTS.CHAT_STATUS)[keyof typeof CONVERSATION_CONSTANTS.CHAT_STATUS];
export type FriendRequestStatus =
  (typeof CONVERSATION_CONSTANTS.FRIEND_REQUEST_STATUS)[keyof typeof CONVERSATION_CONSTANTS.FRIEND_REQUEST_STATUS];
export type SystemAction =
  (typeof CONVERSATION_CONSTANTS.SYSTEM_ACTIONS)[keyof typeof CONVERSATION_CONSTANTS.SYSTEM_ACTIONS];
