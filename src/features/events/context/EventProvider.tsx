...
interface EventContextType {
  ...
  updateEventExtras: (eventId: string, extras: {
    costs?: any[];
    coHosts?: any[];
    questionnaire?: any[];
    itemsToBring?: any[];
...
export function EventProvider({ children }: { children: ReactNode }) {
  ...
  // Create new event
  const createEvent = useCallback(async (eventData: CreateEventData): Promise<EventOperationResult> => {
  ...
  const updateLocalEvent = useCallback((updates: Partial<any>) => {
    if (currentEvent) {
  ...
  const updateEventExtras = useCallback(async (eventId: string, extras: {
    costs?: any[];
    coHosts?: any[];
    questionnaire?: any[];
    itemsToBring?: any[];
    ...
    if (currentEvent && currentEvent.id === eventId) {
      const updatedEvent = {
        ...
        ...(extras.rsvpReminderEnabled !== undefined && { rsvp_reminder_enabled: extras.rsvpReminderEnabled }),
        ...(extras.rsvpReminderTiming !== undefined && { rsvp_reminder_timing: extras.rsvpReminderTiming }),
