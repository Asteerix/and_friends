    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity style={[styles.button, styles.offlineButton]} onPress={simulateOffline}>
        ...
        <TouchableOpacity style={[styles.button, styles.cacheButton]} onPress={handleCleanCache}>
