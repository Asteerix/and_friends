...
const faqData: FAQItem[] = [
  // Getting Started
  {
    ...
    answer: 'To create an account, download the & friends app and sign up with your phone number. You\'ll receive a verification code via SMS. After verification, you can set up your profile with your name, photo, and interests.',
  },
  {
    id: '2',
    category: 'Getting Started',
    question: 'Is & friends free to use?',
    answer: 'Yes! & friends is completely free to download and use. All core features including creating events, joining events, messaging, and sharing stories are available at no cost.',
  },
  {
    id: '3',
    category: 'Getting Started',
    question: 'How do I find friends on the app?',
    answer: 'You can find friends by:\n• Syncing your contacts to see who\'s already on & friends\n• Searching for friends by username\n• Discovering people at events you attend\n• Getting friend suggestions based on mutual connections',
  },
  ...
  // Stories & Memories
  {
    ...
    answer: 'Stories are photos or videos you share that disappear after 24 hours. They\'re a fun way to share moments from your day with friends without permanently posting them.',
  },
  {
    id: '9',
    category: 'Stories',
    question: 'How do I create a Story?',
    answer: 'Tap the "+" button on your profile picture in the Stories section, or tap the camera icon. You can:\n• Take a photo or video\n• Choose from your gallery\n• Add text, stickers, or drawings\n• Choose who can see your story',
  },
  {
    id: '10',
    category: 'Stories',
    question: 'Who can see my Stories?',
    answer: 'You control who sees your stories:\n• Everyone: All & friends users\n• Friends Only: Only your friends\n• Custom: Select specific friends\n\nYou can also hide stories from specific people in your privacy settings.',
  },
  ...
  // Messages & Chat
  {
    ...
    answer: 'You can message friends by:\n• Tapping the chat icon on their profile\n• Starting a new chat from the Messages tab\n• Replying to their story\n• Messaging in an event group chat',
  },
  {
    id: '12',
    category: 'Messages',
    question: 'Can I delete messages?',
    answer: 'Yes, you can delete messages you\'ve sent. Press and hold on a message to see options. Deleted messages will show "This message was deleted" to other participants.',
  },
  {
    id: '13',
    category: 'Messages',
    question: 'What are event group chats?',
    answer: 'Each event automatically has a group chat for all attendees. It\'s a great place to:\n• Coordinate plans\n• Share updates\n• Post photos during/after the event\n• Stay connected with people you met',
  },
  ...
  // Account & Settings
  {
    ...
    answer: 'Currently, phone numbers cannot be changed directly in the app for security reasons. Please contact support at support@andfriends.app to update your phone number.',
  },
  {
    id: '18',
    category: 'Account',
    question: 'Can I have multiple accounts?',
    answer: 'Each phone number can only be associated with one account. We don\'t support multiple accounts per user to maintain authenticity and trust in the community.',
  },
  {
    id: '19',
    category: 'Account',
  ...
  },
  {
    ...
    answer: 'If uploads are failing:\n• Check your internet connection\n• Ensure the app has photo/camera permissions\n• Try reducing file size (photos under 10MB, videos under 100MB)\n• Clear app cache and try again\n• Make sure you have enough storage',
  },
];

const categories = ['All', 'Getting Started', 'Events', 'Stories', 'Messages', 'Privacy', 'Account', 'Troubleshooting'];
