...
export default function StoriesScreen({ route, navigation }: any) {
  ...
  const { userStories, markAsViewed, loading } = useStories();
  
  const [currentUserIndex, setCurrentUserIndex] = useState(
    userStories.findIndex(u => u.userId === initialUserId) || 0
  );
        ...
        <SafeAreaView style={styles.header}>
          ...
          <View style={styles.userInfo}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Profile', { userId: currentUser.userId })}
            >
