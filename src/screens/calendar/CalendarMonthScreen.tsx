...
const gradients = [
  gradientPresets.calendar1,
  gradientPresets.calendar2,
  gradientPresets.calendar3,
];
...
export default function CalendarMonthScreen() {
  ...
  const handleDatePress = (day: Date) => {
    ...
    navigation.navigate('CalendarScreen' as never, { selectedDate: day.toISOString() } as never);
  };

  const weekDays = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];

  return (
    <GradientBackground colors={gradients[currentGradient]} animated>
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.monthSelector}>
            ...
            >
              <CustomText size="lg" color="#000">‹</CustomText>
            </TouchableOpacity>
                    ...
                    <View style={styles.eventIndicators}>
                      {dayEvents.slice(0, 3).map((_, index) => (
                        <View
                          ...
                          style={[
                            styles.eventDot,
                            (isToday || isSelected) && styles.eventDotLight,
                          ]}
                        />
                      ))}
                    </View>
        ...
        <ScrollView style={styles.eventsList} showsVerticalScrollIndicator={false}>
          ...
          {getEventsForDay(selectedDate).map((event) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('EventDetailsScreen' as never, { eventId: event.id } as never)}
              activeOpacity={0.8}
            >
