...
export default function SearchScreen() {
  ...
  const handleResultPress = (result: SearchResult) => {
    ...
    if (result.type === 'user') {
      navigation.navigate('PersonCard' as never, { userId: result.id } as never);
    } else if (result.type === 'event') {
      navigation.navigate('EventDetailsScreen' as never, { eventId: result.id } as never);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.searchBar}>
          <CustomText size="lg" style={styles.searchIcon}>🔍</CustomText>
          <TextInput
        ...
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.cancelButton}>
          <CustomText size="md" color="#007AFF">Cancel</CustomText>
        </TouchableOpacity>
      </Animated.View>
      ...
      {searchQuery.length === 0 ? (
        <View style={styles.recentContainer}>
          ...
          {recentSearches.map((search, index) => (
            ...
            >
              <CustomText size="md" color="#999">🕐</CustomText>
              <CustomText size="md" style={styles.recentText}>{search}</CustomText>
            </TouchableOpacity>
          ))}
        </View>
      ) : (
